package com.cmbc.codegenerator.freemarker;
...
public class FreemarkerHelper {
    ...
    public static String processTemplateString(String templateString,Object model,Configuration conf) {
    ...
    public static void main(String[] args){
        ...
        Map templateContext = new HashMap<String,String>();
        templateContext.put("a","bbbb");
        String aa = FreemarkerHelper.processTemplateString("${a}", templateContext, configuration);
