	...
	public NavigationService() {
		...
		businessNode
				.addChild(new MenuNode(
						...
						"xcore.view.poll.PollChart", Role.USER, Role.ADMIN));
		...
		administrationNode
				.addChild(new MenuNode(
						...
						"xcore.view.user.List", Role.ADMIN));
		...
		systemNode
				.addChild(new MenuNode(
						...
						"xcore.view.accesslog.List", Role.ADMIN));
		systemNode
				.addChild(new MenuNode(
						"logevents",
						"data:image/png;base64,",
						"xcore.view.logevent.List", Role.ADMIN));
		systemNode
				.addChild(new MenuNode(
						"config",
						...
						"xcore.view.config.Edit", Role.ADMIN));
