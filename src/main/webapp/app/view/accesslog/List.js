Ext.define('xcore.view.accesslog.List', {
	extend: 'Ext.grid.Panel',
	controller: 'xcore.controller.AccessLog',
	title: i18n.accesslog,
	closable: true,
	border: true,

	requires: [ 'xcore.ux.form.field.FilterField', 'xcore.store.AccessLogs' ],

	initComponent: function() {
		var me = this;

		me.store = Ext.create('xcore.store.AccessLogs');
