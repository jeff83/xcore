Ext.define('xcore.controller.Config', {
	...
	onSaveButtonClick: function() {
		...
		appConfigurationService.save(form.getFieldValues(), function() {
			xcore.ux.window.Notification.info(i18n.successful, i18n.config_saved);
		});
	},
		...
		if (form.isValid()) {
			appConfigurationService.save(form.getFieldValues(), function() {
				...
				appConfigurationService.sendTestEmail(testReceiver, function() {
					xcore.ux.window.Notification.info(i18n.successful, i18n.config_testEmailsent);
				});
			});
		} else {
			appConfigurationService.sendTestEmail(testReceiver, function() {
